// Service Worker de App Completa — red primero, caché como respaldo sin
...
const CACHE_NAME = 'app-completa-shell-v35b';
...
self.addEventListener('fetch', (event) => {
  ...
  const esDocumentoPrincipal = req.mode === 'navigate' || req.url.includes(SHELL_FILE) || req.url.endsWith('/');
